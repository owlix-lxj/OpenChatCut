...
const BASE_URL_NAMES = ['ELEVENLABS_BASE_URL', 'DOUBAO_TTS_BASE_URL', 'MUREKA_BASE_URL', 'SEEDANCE_BASE_URL', 'JIMENG_BASE_URL', 'KLING_BASE_URL'] as const;
...
const MODEL_ROUTING_NAMES = [
  ...
  'QWEN_AUDIO_BASE_URL', 'QWEN_TTS_MODEL', 'QWEN_ASR_MODEL',
  'DOUBAO_TTS_RESOURCE_ID', 'SEEDANCE_VIDEO_MODEL', 'JIMENG_BASE_URL', 'KLING_VIDEO_MODEL', 'MUREKA_MUSIC_MODEL',
