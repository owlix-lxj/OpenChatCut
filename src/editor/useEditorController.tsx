...
function buildEditorWorkspaceViewProps(
  ...
  const { chatSeed, setChatSeed, showDesign, setShowDesign, showVersions, setShowVersions, showShortcuts, setShowShortcuts, digitalHumanOpenNonce, openDigitalHuman, shortcutApiRef, getPlayhead } = ui.dialogs;
  ...
  return {
    ...
    topBar: { projectName: project.name, exporting: activeExportJobs > 0, exportJobCount: activeExportJobs, canUndo, canRedo, onHome: handleHome, onRename },
